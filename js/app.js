...
document.addEventListener("DOMContentLoaded", function () {
  const abrirModalEmail = document.getElementById("abrirModalEmail");
  const modalEmail = document.getElementById("modalEmail");
  const fechar = modalEmail.querySelector(".fechar");
  const emailForm = document.getElementById("modalEmail");

  abrirModalEmail.addEventListener("click", function () {
